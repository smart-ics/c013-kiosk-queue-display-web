...
| Doc | Use when |
|-----|----------|
| [TRACKER-ADMISSION-QUEUE-IIS-CLIENT-CUTOVER-CHECKLIST.md](./TRACKER-ADMISSION-QUEUE-IIS-CLIENT-CUTOVER-CHECKLIST.md) | IIS Go / No-Go for kiosk + display |
| [TRACKER-ADMISSION-QUEUE-RUNBOOK.md](./TRACKER-ADMISSION-QUEUE-RUNBOOK.md) | Full migrate/config/smoke + §§8–11 client E2E |
...
| Doc | Phase |
|-----|-------|
| [tracker-c2-kiosk-implementation-report.md](./tracker-c2-kiosk-implementation-report.md) | C2 Kiosk |
| [tracker-c3-queue-display-implementation-report.md](./tracker-c3-queue-display-implementation-report.md) | C3 Display |
| [tracker-c4-integration-deployment-implementation-report.md](./tracker-c4-integration-deployment-implementation-report.md) | C4 Integration & Deployment |
| [TRACKER-ADMISSION-QUEUE-EXTERNAL-CLIENTS-IMPLEMENTATION-PLAN.md](./TRACKER-ADMISSION-QUEUE-EXTERNAL-CLIENTS-IMPLEMENTATION-PLAN.md) | Part 2 plan (C0–C4 closed) |

Local one-line pointers (historical): [C2](./C2-implementation-summary.md) · [C3](./C3-implementation-summary.md) · [C4](./C4-implementation-summary.md)
