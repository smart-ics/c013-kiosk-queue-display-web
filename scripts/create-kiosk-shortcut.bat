...
# ==============================================================================
#                 KIOSK & DISPLAY SHORTCUT CREATOR FOR WINDOWS
# ==============================================================================
...
Write-Host "       KIOSK & DISPLAY SHORTCUT CREATOR FOR WINDOWS       " -ForegroundColor Cyan
Write-Host "=========================================================" -ForegroundColor Cyan
Write-Host ""
...
if ($installed.Count -eq 0) {
    ...
    Write-Host "Pilih browser yang ingin digunakan untuk Kiosk Mode:" -ForegroundColor White
...
while ([string]::IsNullOrWhiteSpace($url)) {
    $url = Read-Host "Masukkan URL target Kiosk (contoh: http://192.168.10.5/kiosk/loket-03)"
    $url = $url.Trim()
...
Write-Host ""
$shortcutName = Read-Host "Masukkan nama file shortcut (Default: Kiosk_Shortcut)"
if ([string]::IsNullOrWhiteSpace($shortcutName)) {
    $shortcutName = "Kiosk_Shortcut"
}
